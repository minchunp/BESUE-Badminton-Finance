...
const GreetingCard = ({ userName, scheduledHostsCount }: GreetingCardProps) => {
   return (
      <motion.section
         ...
         className="relative h-[140px] rounded-2xl bg-gradient-to-br from-[#d8b4fe] to-[#ffadb5] p-6 overflow-hidden shadow-glass flex items-center"
      >
         ...
         <div className="absolute right-[-15px] top-[-10px] w-44 h-44 opacity-95 drop-shadow-xl select-none pointer-events-none animate-float">
